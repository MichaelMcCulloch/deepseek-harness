/**
 * The outbound telemetry vocabulary — record, severity, and the minimum sink
 * contract — shared by the Service Definition and the capture coordinator. It
 * lives in this leaf module so the coordinator never imports the package
 * barrel, which re-exports the coordinator itself.
 *
 * @module @deepseek-ai/dsh-session-telemetry/types
 */
