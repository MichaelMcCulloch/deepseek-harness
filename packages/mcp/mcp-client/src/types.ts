/**
 * Configuration vocabulary shared by the plugin entry, the connection
 * supervisor, and the transport factory. The declarations live in this leaf
 * module so those consumers never import the package barrel, whose own
 * `apply` reaches back into the supervisor.
 *
