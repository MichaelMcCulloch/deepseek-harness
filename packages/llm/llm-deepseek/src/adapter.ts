...
import type { DeepSeekCatalogModel, DeepSeekConnectionOptions } from './connection.ts'
...
export type { DeepSeekCatalogModel, DeepSeekConnectionOptions } from './connection.ts'
