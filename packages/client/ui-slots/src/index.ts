 ...
 * a consumer's `declare module '@deepseek-ai/dsh-client-ui-slots'` augmentation
 * merges with them here, and equally with the declarations this entry
...
import type {
  SessionAreaProps, SlotEntryDef, SlotKind, SlotLabel, SlotScope, SlotSpec, StoredEntry, StoredFactory, Translate,
} from './types.ts'

export * from './store.ts'
export * from './renderer.ts'
// The slot-registry declarations shared with the renderer contract live in
// their own leaf module so this entry and `./renderer.ts` can both name them;
// re-exported here so `@deepseek-ai/dsh-client-ui-slots` stays the single
// public API.
export type {
  SessionAreaProps, SlotEntryDef, SlotKind, SlotLabel, SlotScope, SlotScopeTargetMap, SlotSpec, StoredEntry,
  StoredFactory, Translate,
} from './types.ts'
