...
| `ctx.dag` | `core` | [`dag`](../packages/dag/dag) | - | [`tool-dag`](../packages/dag/tool-dag) | - | Commits complete revisioned graph snapshots before it schedules fenced Git, child, notice, and lifecycle effects. |
