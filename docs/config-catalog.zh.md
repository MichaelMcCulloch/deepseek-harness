...
<!-- BEGIN GENERATED config-catalog:@deepseek-ai/dsh-dag -->
<a id="deepseek-aidsh-dag"></a>
...
```
<!-- END GENERATED config-catalog:@deepseek-ai/dsh-dag -->
...
- `inject`: `tools`
- `source`: [`packages/mcp/mcp-client/src/index.ts:53`](../packages/mcp/mcp-client/src/index.ts)
...
- `refs`: `Volatile` (`@deepseek-ai/cordis`)
- `source`: [`packages/subagent/subagent/src/index.ts:209`](../packages/subagent/subagent/src/index.ts)
...
- `inject`: `systemPrompt`
- `source`: [`packages/core/tools/src/index.ts:408`](../packages/core/tools/src/index.ts)
...
| `@deepseek-ai/dsh-client-ui-dag` | — | [`packages/client/ui-dag/src/index.ts`](../packages/client/ui-dag/src/index.ts) |
...
| `@deepseek-ai/dsh-tool-dag` | `tools` · `dag` · `systemPrompt` | [`packages/dag/tool-dag/src/index.ts`](../packages/dag/tool-dag/src/index.ts) |
