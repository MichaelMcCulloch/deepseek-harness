...
- **DAG coordination:** run the native dependency graph through its own tools, wait with `dag_wait` instead of polling, and keep DAG Git local ([rules](docs/subsystems/dag.md)).
