...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-dag': { kind: 'none', reason: 'Browser-side read-only projection of the durable DAG board; the host DAG package owns the model-facing tools and prompt sections.' },
